...
SRCFILES := testhat.c hatrack_common.c oldhat.c counters.c hihat-a.c woolhat.c swimcap.c duncecap.c debug.c xxhash.c refhat.c lohat-b.c lohat.c test.c lohat-a.c mmm.c hihat.c witchhat.c tophat.c newshat.c ballcap.c
