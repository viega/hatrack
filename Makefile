...
UNUSED   :=  -DHATRACK_ALWAYS_USE_QSORT -DHIHAT64_USE_FULL_HASH 
EXTRAS   := -DHATRACK_QSORT_THRESHOLD=256 -g -DHATRACK_MMMALLOC_CTRS -DHATRACK_COUNTERS -DHATRACK_DEBUG
CFLAGS   :=  -std=c11 -Wall -Werror ${OPT} -I../include ${EXTRAS}
PROGNAME := test

all: ${PROGNAME} Makefile

SRCFILES := lowhat1.c lowhat2.c lowhat0.c hihat1.c hihat64.c swimcap.c refhat0.c hatrack_common.c mmm.c counters.c testhat.c test.c debugbuffer.c xxhash.c 
...
testhat.o: testhat.c testhat.h hihat1.h hihat64.h lowhat1.h lowhat2.h lowhat0.h refhat0.h swimcap.h hatrack_common.h hash.h mmm.h counters.h
test.o: test.c hash.h xxhash.h testhat.h hihat1.h hihat64.h lowhat1.h lowhat2.h lowhat0.h refhat0.h swimcap.h hatrack_common.h hash.h mmm.h counters.h
