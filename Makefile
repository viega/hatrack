...
SRCFILES := lowhat1.c lowhat2.c lowhat0.c hihat1.c hihat64.c swimcap.c swimcap2.c refhat0.c hatrack_common.c mmm.c counters.c testhat.c test.c debugbuffer.c xxhash.c 
