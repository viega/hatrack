...
UNUSED   :=  -DHATRACK_ALWAYS_USE_QSORT -DHIHAT64_USE_FULL_HASH -g -DHATRACK_MMMALLOC_CTRS -DHATRACK_COUNTERS 
EXTRAS   := -DHATRACK_QSORT_THRESHOLD=256 -DHATRACK_DEBUG -g
