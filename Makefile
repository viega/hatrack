...
UNUSED   :=  -DHATRACK_ALWAYS_USE_QSORT -DHATRACK_MIN_SIZE_LOG=14 
EXTRAS   := -DHATRACK_QSORT_THRESHOLD=256 -DHATRACK_MMMALLOC_CTRS -DHATRACK_COUNTERS -g
CFLAGS   :=  -std=c11 -Wall -Werror ${OPT} -I../include ${EXTRAS}
PROGNAME := test

all: ${PROGNAME} Makefile

SRCFILES := lowhat1.c lowhat2.c lowhat0.c hihat1.c swimcap.c refhat0.c hatrack_common.c mmm.c counters.c testhat.c test.c xxhash.c 
...
#hihat64.o: hihat64.c hihat1.h hatrack_common.h hash.h mmm.h counters.h
...
testhat.o: testhat.c testhat.h hihat1.h lowhat1.h lowhat2.h lowhat0.h refhat0.h swimcap.h hatrack_common.h hash.h mmm.h counters.h
test.o: test.c hash.h xxhash.h testhat.h hihat1.h lowhat1.h lowhat2.h lowhat0.h refhat0.h swimcap.h hatrack_common.h hash.h mmm.h counters.h
