...
enum : uint64_t
{
    ...
    HATRACK_CTR_HI2_SLEEP1a_WORKED,
    HATRACK_CTR_HI2_SLEEP1a_FAILED,
    HATRACK_CTR_HI2_SLEEP1b_WORKED,
    HATRACK_CTR_HI2_SLEEP1b_FAILED,
    HATRACK_CTR_HI2_SLEEP2a_WORKED,
    HATRACK_CTR_HI2_SLEEP2a_FAILED,
    HATRACK_CTR_HI2_SLEEP2b_WORKED,
    HATRACK_CTR_HI2_SLEEP2b_FAILED,
...
enum : uint64_t
{
    ...
    WITCHHAT_CTR_BUCKET_ACQUIRE = 73,
    WITCHHAT_CTR_REC_INSTALL    = 74,
    WITCHHAT_CTR_DEL            = 75,
    WITCHHAT_CTR_F_MOVING       = 76,
    WITCHHAT_CTR_NEW_STORE      = 77,
    WITCHHAT_CTR_F_MOVED1       = 78,
    WITCHHAT_CTR_MIGRATE_HV     = 79,
    WITCHHAT_CTR_MIG_REC        = 80,
    WITCHHAT_CTR_F_MOVED2       = 81,
    WITCHHAT_CTR_LEN_INSTALL    = 82,
    WITCHHAT_CTR_STORE_INSTALL  = 83,
    WOOLHAT_CTR_BUCKET_ACQUIRE  = 84,
    WOOLHAT_CTR_REC_INSTALL     = 85,
    WOOLHAT_CTR_DEL             = 86,
    WOOLHAT_CTR_NEW_STORE       = 87,
    WOOLHAT_CTR_F_MOVING        = 88,
    WOOLHAT_CTR_F_MOVED1        = 89,
    WOOLHAT_CTR_F_MOVED2        = 90,
    WOOLHAT_CTR_MIGRATE_HV      = 91,
    WOOLHAT_CTR_MIG_REC         = 92,
    WOOLHAT_CTR_F_MOVED3        = 93,
    WOOLHAT_CTR_LEN_INSTALL     = 94,
    WOOLHAT_CTR_STORE_INSTALL   = 95,
