...
// clang-format off
const    uint64_t target_ops       = 1 << 22;
static   gate_t  *gate;
...
thread_params_t thread_params[] = {
    ...
    {4, 1}, {4, 10}, {4, 100}, {4, 1000}, {4, 10000}, 
    {8, 1}, {8, 10}, {8, 100}, {8, 1000}, {8, 10000}, 
/*    {16, 1}, {16, 10}, {16, 100}, {16, 1000}, {16, 10000}, 
    {32, 1}, {32, 10}, {32, 100}, {32, 1000}, {32, 10000}, 
    {64, 1}, {64, 10}, {64, 100}, {64, 1000}, {64, 10000}, 
    {128, 1}, {128, 10}, {128, 100}, {128, 1000}, {128, 10000}, */
    {0, 0}
};
