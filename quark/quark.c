...
extern _Bool atomic_compare_exchange_16(__int128_t *address,
                                       __int128_t *expected_value,
                                       __int128_t new_value);

__int128_t atomic_load_16(__int128_t *address)
{
    ...
    __int128_t value = 0;
    atomic_compare_exchange_16(address, &value, 0);

    return value;
}

__int128_t atomic_store_16(__int128_t *address, __int128_t new_value) {
    ...
    while (!atomic_compare_exchange_16(address, &value, new_value));
}

__int128_t atomic_fetch_or_16(__int128_t *address, __int128_t operand) {
    ...
    } while(!atomic_compare_exchange_16(address, &value, retval));
